...
abstract final class AppRoutes {
  ...
  static const centralPricingRules = '/pricing/rules';
  ...
  static const roamLpa = '/roam-lpa';
  static const nekokoLpa = roamLpa;
  static const notificationRules = '/notifications/rules';
  static const operations = '/operations';
  static const providerUsage = '/provider-tools/usage';
  static const providerRenew = '/provider-tools/renew';
  static const simConverter = '/sim-converter';
  static const simTools = '/sim-tools';
...
GoRouter createAppRouter({
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (_, _) => const RoleDashboardScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      redirect: (_, s) => s.extra is MobilePackage ? null : AppRoutes.packages,
      builder: (_, s) =>
          PackageDetailScreen(package: s.extra! as MobilePackage),
    ),
    GoRoute(
      path: AppRoutes.checkout,
      redirect: (_, s) => s.extra is MobilePackage ? null : AppRoutes.packages,
      builder: (_, s) => CheckoutScreen(package: s.extra! as MobilePackage),
    ),
    GoRoute(
      path: AppRoutes.checkoutSuccess,
      redirect: (_, s) =>
          s.extra is MobileOrderResult ? null : AppRoutes.orders,
      builder: (_, s) =>
          OrderSuccessScreen(result: s.extra! as MobileOrderResult),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (_, _) => const DealerNetworkScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      ...
      builder: (_, _) => const AdminCommercialScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminProviderRetry,
      builder: (_, _) => const ProviderRetryScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminProviderCallbacks,
      builder: (_, _) => const ProviderCallbackLogsScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminProviderHealth,
      builder: (_, _) => const ProviderHealthScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminRouting,
      builder: (_, _) => const AdminRoutingScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminManualFulfillment,
      builder: (_, _) => const ManualFulfillmentScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminGovernance,
      builder: (_, _) => const AdminGovernanceScreen(),
    ),
    GoRoute(
      path: AppRoutes.adminWhatsApp,
      builder: (_, _) => const AdminWhatsAppScreen(),
    ),
    GoRoute(
      path: AppRoutes.centralPricingRules,
      builder: (_, _) => const CentralPricingRulesScreen(),
    ),
    GoRoute(
      path: AppRoutes.customerPricing,
      builder: (_, _) => const CustomerPricingScreen(),
    ),
    GoRoute(
      path: AppRoutes.dealerPricing,
      builder: (_, _) => const DealerPricingScreen(),
    ),
    GoRoute(
      path: AppRoutes.finance,
      builder: (_, _) => const RoleFinanceLedgerScreen(),
    ),
    GoRoute(path: AppRoutes.esims, builder: (_, _) => const EsimsScreen()),
    GoRoute(
      path: AppRoutes.esimHistory,
      builder: (_, _) => const EsimHistoryScreen(),
    ),
    GoRoute(
      path: AppRoutes.tgtBulkOperations,
      builder: (_, _) => const TgtBulkOperationsScreen(),
    ),
    GoRoute(
      path: AppRoutes.esimDetail,
      redirect: (_, s) => s.extra is MobileEsim ? null : AppRoutes.esims,
      builder: (_, s) => EsimDetailScreen(initialEsim: s.extra! as MobileEsim),
    ),
    GoRoute(
      path: AppRoutes.orders,
      builder: (_, s) => OrdersScreen(
        initialOrderId: int.tryParse(s.uri.queryParameters['order_id'] ?? ''),
      ),
    ),
    GoRoute(
      path: AppRoutes.orderDetail,
      redirect: (_, s) =>
          s.extra is MobileOrderSummary ? null : AppRoutes.orders,
      builder: (_, s) =>
          OrderDetailScreen(order: s.extra! as MobileOrderSummary),
    ),
    ...
    GoRoute(
      path: AppRoutes.simCards,
      builder: (_, _) => const SimCardsScreen(),
    ),
    GoRoute(
      path: AppRoutes.simCardOrders,
      builder: (_, _) => const SimCardOrderHistoryScreen(),
    ),
    ...
    GoRoute(
      path: AppRoutes.roamLpa,
      builder: (_, s) => RoamLpaScreen(
        activationCode: s.extra is String ? s.extra! as String : null,
      ),
    ),
    GoRoute(
      path: AppRoutes.notificationRules,
      builder: (_, _) => const NotificationRulesScreen(),
    ),
    GoRoute(
      path: AppRoutes.operations,
      builder: (_, _) => const OperationsCenterScreen(),
    ),
    GoRoute(
      path: AppRoutes.providerUsage,
      builder: (_, _) => const ProviderOperationsScreen(initialTab: 0),
    ),
    GoRoute(
      path: AppRoutes.providerRenew,
      builder: (_, _) => const ProviderOperationsScreen(initialTab: 1),
    ),
    GoRoute(
      path: AppRoutes.simConverter,
      builder: (_, _) => const SimConverterScreen(),
    ),
    GoRoute(
      path: AppRoutes.simTools,
      builder: (_, _) => const SimToolsScreen(),
    ),
    GoRoute(
