...
class SimCardOrderHistoryScreen extends StatefulWidget {
  ...
  @override
  State<SimCardOrderHistoryScreen> createState() =>
      _SimCardOrderHistoryScreenState();
}
            ...
            children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Track your physical SIM stock orders.',
              ...
              if (_loading)
                ...
                const ContentEmptyState(
                  ...
                  title: 'No SIM orders',
                  message: 'Physical SIM stock orders will appear here.',
                )
              else
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (order.providerOrderId != null &&
                              order.providerOrderId!.isNotEmpty) ...[
                            const SizedBox(height: 8),
                            Text(
                              'Fulfillment: ${order.providerOrderId}',
