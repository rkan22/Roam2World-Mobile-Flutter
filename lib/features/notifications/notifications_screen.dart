      ...
      body: ListView(
        ...
        children: const [
          ...
          _NotificationTile(
            ...
            message: 'Order #ORD-2026-000124 is ready. The eSIM QR code can now be shared.',
            time: '8 min ago',
            unread: true,
          ),
          SizedBox(height: 10),
          _NotificationTile(
            ...
            message: 'Your top-up request for $1,000 has been approved.',
            time: '42 min ago',
            unread: true,
          ),
          SizedBox(height: 20),
          ...
          _NotificationTile(
            ...
            message: 'One purchased eSIM has not been installed yet.',
            time: 'Yesterday',
          ),
          SizedBox(height: 10),
          _NotificationTile(
            ...
            message: 'A new Europe 20 GB package has been added to the catalogue.',
            time: '2 days ago',
          ),
        ],
      ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(time, style: const TextStyle(fontSize: 12, color: AppColors.textTertiary, fontWeight: FontWeight.w700)),
              ],
            ),
          ),
        ],
