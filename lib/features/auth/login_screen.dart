            ...
            child: ConstrainedBox(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Row(children: [
                      Container(height: 56, width: 56, decoration: BoxDecoration(color: AppColors.primary, borderRadius: BorderRadius.circular(18)), child: const Icon(Icons.public_rounded, color: Colors.white, size: 30)),
                    ...
                    const Text('Manage packages, orders, eSIMs and wallet operations securely.', style: TextStyle(fontSize: 16, height: 1.5, color: AppColors.textSecondary)),
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        ...
                        ElevatedButton(
                          ...
                          child: _isLoading ? const SizedBox(height: 22, width: 22, child: CircularProgressIndicator(strokeWidth: 2.4, color: Colors.white)) : const Text('Sign in'),
                        ),
                      ]),
                    ),
