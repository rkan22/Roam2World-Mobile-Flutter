...
require_match 'applicationId = "com\.roam2world\.mobile"' android/app/build.gradle.kts
require_match 'namespace = "com\.roam2world\.mobile"' android/app/build.gradle.kts
